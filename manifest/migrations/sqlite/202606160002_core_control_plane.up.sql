...
VALUES
  ('pt-temperature', 'dev-edge-gw-a01', 'com.gcoll.modbus-tcp', 'TEMP_01', '环境温度', 'holding_register:40001', 'float', '℃', 1, '{"area":"A","kind":"environment"}', '{"area":"holding_register","mode":"read","quantity":2,"byteOrder":"big","wordOrder":"big","scale":1,"offset":0}'),
  ('pt-pressure', 'dev-edge-gw-a01', 'com.gcoll.modbus-tcp', 'PRESS_01', '管线压力', 'holding_register:40003', 'float', 'kPa', 1, '{"area":"A","kind":"process"}', '{"area":"holding_register","mode":"read","quantity":2,"byteOrder":"big","wordOrder":"big","scale":1,"offset":0}'),
  ('pt-motor-state', 'dev-edge-gw-a01', 'com.gcoll.modbus-tcp', 'MOTOR_RUN', '电机运行状态', 'coil:00001', 'bool', '', 1, '{"area":"A","kind":"status"}', '{"area":"coil","mode":"read","quantity":1,"byteOrder":"big","wordOrder":"big","scale":1,"offset":0}'),
  ('pt-energy', 'dev-edge-gw-a01', 'com.gcoll.modbus-tcp', 'ENERGY_TOTAL', '累计能耗', 'input_register:30001', 'float', 'kWh', 1, '{"area":"A","kind":"meter"}', '{"area":"input_register","mode":"read","quantity":2,"byteOrder":"big","wordOrder":"little","scale":1,"offset":0}'),
  ('pt-speed-set', 'dev-edge-gw-a01', 'com.gcoll.modbus-tcp', 'SPEED_SET', '速度设定值', 'holding_register:40110', 'int', 'rpm', 1, '{"area":"A","kind":"write"}', '{"area":"holding_register","mode":"write","quantity":1,"byteOrder":"big","wordOrder":"big","scale":1,"offset":0}'),
  ('pt-emergency', 'dev-edge-gw-a01', 'com.gcoll.modbus-tcp', 'EMERGENCY_STOP', '急停输入状态', 'discrete_input:10001', 'bool', '', 1, '{"area":"A","kind":"safety"}', '{"area":"discrete_input","mode":"read","quantity":1,"byteOrder":"big","wordOrder":"big","scale":1,"offset":0}')
ON CONFLICT(id) DO UPDATE SET
  name = excluded.name,
  description = excluded.description,
...
VALUES
  ('mpp-pt-temperature', 'dev-edge-gw-a01', 'pt-temperature', 'com.gcoll.modbus-tcp', 1, 'holding_register', 0, 2, 'read', 'float32', 'big', 'big', 1, 0, 'change', 1),
  ('mpp-pt-pressure', 'dev-edge-gw-a01', 'pt-pressure', 'com.gcoll.modbus-tcp', 1, 'holding_register', 2, 2, 'read', 'float32', 'big', 'big', 1, 0, 'change', 1),
  ('mpp-pt-motor-state', 'dev-edge-gw-a01', 'pt-motor-state', 'com.gcoll.modbus-tcp', 1, 'coil', 0, 1, 'read', 'bool', 'big', 'big', 1, 0, 'change', 1),
  ('mpp-pt-energy', 'dev-edge-gw-a01', 'pt-energy', 'com.gcoll.modbus-tcp', 1, 'input_register', 0, 2, 'read', 'float32', 'big', 'little', 1, 0, 'change', 1),
  ('mpp-pt-speed-set', 'dev-edge-gw-a01', 'pt-speed-set', 'com.gcoll.modbus-tcp', 1, 'holding_register', 109, 1, 'write', 'uint16', 'big', 'big', 1, 0, 'change', 1),
  ('mpp-pt-emergency', 'dev-edge-gw-a01', 'pt-emergency', 'com.gcoll.modbus-tcp', 1, 'discrete_input', 0, 1, 'read', 'bool', 'big', 'big', 1, 0, 'change', 1)
